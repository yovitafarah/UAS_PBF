    ...
    render (){
        ...
        return (
            <div>
                ...
                {/*SEO Support*/}
                <Helmet>
                    <title>React.js | CheckOut Page</title>
                    <meta name="description" content="React.js – Multipurpose eCommerce React Template is a multi-use React template. It is designed to go well with multi-purpose websites. React.js Bootstrap 4 Template will help you run multiple businesses." />
                </Helmet>
                {/*SEO Support End */}
                                                                ...
                                                                <li>
                                                                    <div className="radio-option paypal">
                                                                        <input type="radio" name="payment-group" id="payment-1" onClick={() => this.checkhandle('paypal')} />
                                                                            <label htmlFor="payment-1">PayPal<span className="image"><img src={`/users/assets/images/paypal.png`} alt=""/></span></label>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        </div>
