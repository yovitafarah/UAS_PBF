											...
											<div className="icon-nav">
												<ul>
													<li className="onhover-div mobile-search">
														<div><img src={`/users/assets/images/icon/search.png`} onClick={this.openSearch} className="img-fluid" alt="" />
															<i className="fa fa-search" onClick={this.openSearch}/></div>
													</li>
													<li className="onhover-div mobile-setting">
														<div><img src={`/users/assets/images/icon/setting.png`} className="img-fluid" alt="" />
